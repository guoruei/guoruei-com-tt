...
<PanelButton buttonImage="assets/github-mark-white.svg" clickUrl="https://github.com/guoruei/tt" buttonText="GitHub repo">
	<i class='fas fa-star fa-xs ml-auto'></i>
	<span class="ml-1"><GitHubStarCount repo="guoruei/tt"/></span>
</PanelButton>
<p>Like WebVM? <a class="underline" href="https://github.com/guoruei/tt" target="_blank">Give us a star!</a></p>
